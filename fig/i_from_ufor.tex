	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		legend style={
	     ...
	     % \xdef\C{5e-8}
	     % \xdef\R{13000}
		\addplot +[mark=*, line width=1pt, mark size=1pt, solid,ochre] plot [error bars/.cd, y dir = both, y explicit,x dir = both, x explicit] table [ x=uu, y=i] {../data/vax1.tsv};

		% \addplot[color=ochre,samples=1000, domain=0:80]
			% {1.9*25*ln(x/0.03)+x*0.4};
